...
// { orderId: 123, items: [...], _ts: 1234567890 }
...
// 跳转
navigateWithParams('/pages/order/detail', { id: 123 });
...
```javascript
// 默认 navigate
navigateTo('/pages/detail', data);

// 其他类型
navigateTo('/pages/detail', data, 'redirect');  // redirectTo
navigateTo('/pages/detail', data, 'reLaunch');  // reLaunch
navigateTo('/pages/tab', {}, 'switchTab');      // switchTab
```
